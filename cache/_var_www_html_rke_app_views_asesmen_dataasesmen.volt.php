...
<div class="card card-block">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($data as $d) { ?>
                            <tr>
                               ...
                               <a href="<?= $this->url->getStatic('Asesmen/editasesmen/') ?><?= $d->id_asesmen ?>/<?= $d->no_rm ?>" class="btn btn-warning btn-sm"><i class="material-icons">edit</i></a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <form action="<?= $this->url->getStatic('Asesmen/dltasesmen') ?>" method="POST">
