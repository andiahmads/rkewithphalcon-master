...
<?php } ?>
              ...
              <div class="card-footer text-xs-right">
                <?php if ($this->session->st == null) { ?>
                <a href="<?= $this->url->getStatic('detailpembayaran/update/') ?> <?= $datas->id_berobat ?>" name="konfirmasi" onclick="window.popup();"  class="btn btn-info btn-icon btn-sm " value="lunas"  href="javascript:;" title="tombol ini berguna untuk konfirmasi status pasien">
