...
<div class="col-lg-8">
	<div class="col-lg-2">
		<img src="<?= $this->url->getStatic('img/riau.png') ?>" height="150">
	</div>
	<div class="col-lg-9">
...
<form action="<?= $this->url->getStatic('Asesmen/proseseditasesmen/') ?><?= $datas->id_asesmen ?>/1" method="POST" >
...
<!-- bagian A -->
	<div class="form-group">
		<div class="card-header bg-primary">
		 ...
		 <?php if ($datas->nyeri == 'Tidak ada Nyeri') { ?>
        <?php $a = 'checked=""'; ?>
        <?php } elseif ($datas->nyeri == 'Nyeri Kronis') { ?>
        <?php $b = 'checked=""'; ?>
        <?php } elseif ($datas->nyeri == 'Nyeri Akut') { ?>
        <?php $c = 'checked=""'; ?>
        <?php } ?>
		<div class="card-block col-lg-6">
			...
			<div class="form-group m-b">
				...
				<?php if ($datas->nyeri_hilang == 'Minum Obat') { ?>
      <?php $aa = 'checked=""'; ?>
      <?php } elseif ($datas->nyeri_hilang == 'Mendengar Musik') { ?>
      <?php $bb = 'checked=""'; ?>
      <?php } elseif ($datas->nyeri_hilang == 'Istirahat') { ?>
      <?php $cc = 'checked=""'; ?>
      <?php } elseif ($datas->nyeri_hilang == 'Berubah Posisi/Tidur') { ?>
      <?php $dd = 'checked=""'; ?>
      <?php } ?>
				<div class="col-lg-4" >
					<label class=" custom-control custom-radio" >
			...
			<div class="form-group m-b">
				...
				<br>
				<?php if ($datas->info == 'Ya') { ?>
     <?php $hh = 'checked=""' ;?>
     <?php } elseif ($datas->info == 'Tidak') { ?>
     <?php $ii = 'checked=""' ;?>
     <?php } ?>
				<div class="col-lg-7" >
					<div class="col-lg-2">
	...
	<div class="card-header" align="center">
		 <strong> ITEM PENILAIAN </strong> 
			...
			<div class="col-lg-12 m-b-1">
				...
				<?php if ($datas->usia1 == 'Kurang dari 50 tahun') { ?>
				<?php $i = 'checked=""' ?>
				<?php } elseif ($datas->usia1 == '50-70 tahun') { ?>
				<?php $ii = 'checked=""' ?>
				<?php } else { ?>
				<?php $iii = 'checked=""' ?>
				<?php } ?>
        ...
        <label class="m-b-1">STATUS MENTAL :</label><br>
				<?php if ($datas->statusmental2 == 'Kesadaran baik') { ?>
				<?php $j = 'checked=""' ?>
				<?php } elseif ($datas->statusmental2 == 'Agitasi/Ansietas') { ?>
				<?php $jj = 'checked=""' ?>
				<?php } elseif ($datas->statusmental2 == 'Kadang-kadang bingung') { ?>
				<?php $jjj = 'checked=""' ?>
				<?php } else { ?>
				<?php $jjjj = 'checked=""' ?>
				<?php } ?>        
      ...
      <div class="col-lg-12 m-b-1">
        <label class="m-b-1">ELIMINASI :</label><br>
				<?php if ($datas->eliminasi1 == 'Mandiri dan mampu mengontrol BAB/BAK') { ?>
				<?php $k = 'checked=""' ?>
				<?php } elseif ($datas->eliminasi1 == 'Dower Catheter/Colostomy') { ?>
				<?php $kk = 'checked=""' ?>
				<?php } elseif ($datas->eliminasi1 == 'Eliminasi dengan Bantuan') { ?>
				<?php $kkk = 'checked=""' ?>
				<?php } elseif ($datas->eliminasi1 == 'Gangguan Eliminasi') { ?>
				<?php $kkkk = 'checked=""' ?>
				<?php } else { ?>
				<?php $kkkkk = 'checked=""' ?>
				<?php } ?> 
      ...
      <div class="col-lg-12 m-b-1">
        <label class="m-b-1">PENGOBATAN :</label><br>
				<?php if ($datas->pengobatan1 == 'Tanpa obat-obatan') { ?>
				<?php $l = 'checked=""' ?>
				<?php } elseif ($datas->pengobatan1 == 'Obat-obatan jantung') { ?>
				<?php $ll = 'checked=""' ?>
				<?php } elseif ($datas->pengobatan1 == 'Obat-obat psikotropika') { ?>
				<?php $lll = 'checked=""' ?>
				<?php } else { ?>
				<?php $llll = 'checked=""' ?>
				<?php } ?>  
      ...
      <div class="col-lg-12 m-b-1">
        <label class="m-b-1">DIAGNOSA :</label><br>
				<?php if ($datas->diagnosa == 'Bipolar / Gangguan SchizoaffectiveTanpa obat-obatan') { ?>
				<?php $m = 'checked=""' ?>
				<?php } elseif ($datas->diagnosa == 'Penggunaan Obat-obatan Terlarang / Ketergantungan alkohol') { ?>
				<?php $mm = 'checked=""' ?>
				<?php } elseif ($datas->diagnosa == 'Gangguan Depresi Mayor') { ?>
				<?php $mmm = 'checked=""' ?>
				<?php } else { ?>
				<?php $mmmm = 'checked=""' ?>
				<?php } ?> 
      ...
      <div class="col-lg-12 m-b-1">
        <label class="m-b-1">AMBULASI / KESEIMBANGAN :</label><br>
				<?php if ($datas->ambulasi1 == 'Mandiri/ Keseimbangan baik/ immobilisasi') { ?>
				<?php $n = 'checked=""' ?>
				<?php } elseif ($datas->ambulasi1 == 'Dengan Alat Bantu (kursi roda dll)') { ?>
				<?php $nn = 'checked=""' ?>
				<?php } elseif ($datas->ambulasi1 == 'Vertigo/ kelemahan') { ?>
				<?php $nnn = 'checked=""' ?>
				<?php } elseif ($datas->ambulasi1 == 'Goyah tapi lupa keterbatasan') { ?>
				<?php $nnnnn = 'checked=""' ?>
				<?php } else { ?>
				<?php $nnnn = 'checked=""' ?>
				<?php } ?> 
      ...
      <div class="col-lg-12 m-b-1">
        ...
        <?php if ($datas->nutrisi1 == 'Tidak ada kelainan dengan nafsu makan') { ?>
				<?php $oo = 'checked=""' ?>
				<?php } else { ?>
				<?php $o = 'checked=""' ?>
				<?php } ?> 
      ...
      <div class="col-lg-12 m-b-1">
        ...
        <?php if ($datas->polatidur == 'Tidak ada gangguan tidur') { ?>
				<?php $p = 'checked=""' ?>
				<?php } else { ?>
				<?php $pp = 'checked=""' ?>
				<?php } ?> 
      ...
      <div class="col-lg-12 m-b-1">
        ...
        <?php if ($datas->jatuh == 'Tidak ada riwayat jatuh') { ?>
				<?php $s = 'checked=""' ?>
				<?php } else { ?>
				<?php $ss = 'checked=""' ?>
				<?php } ?> 
  ...
  <div class="card-header" align="center">
     <strong> FAKTOR RISIKO </strong> 
      ...
      <div class="col-lg-12 m-b-1">
        ...
        <?php if ($datas->alatbantu1 == 'Perabot') { ?>
        <?php $e = 'checked=""' ?>
        <?php } elseif ($datas->alatbantu1 == 'Tongkat/alat penopang') { ?>
        <?php $ee = 'checked=""' ?>
        <?php } else { ?>
        <?php $eee ='checked=""' ?>
        <?php } ?>
      ...
      <div class="col-lg-12 m-b-1">
        ...
        <?php if ($datas->terpasanginfus == 'Ya') { ?>
        <?php $f = 'checked=""' ?>
        <?php } else { ?>
        <?php $ff ='checked=""' ?>
        <?php } ?>
      ...
      <div class="col-lg-12 m-b-1">
        ...
        <?php if ($datas->gayaberjalan1 == 'Terganggu') { ?>
        <?php $g = 'checked=""' ?>
        <?php } elseif ($datas->gayaberjalan1 == 'Lemah') { ?>
        <?php $gg = 'checked=""' ?>
        <?php } else { ?>
        <?php $ggg ='checked=""' ?>
        <?php } ?>
      ...
      <div class="col-lg-12 m-b-1">
        <label class="m-b-1">STATUS MENTAL :</label><br>
        <?php if ($datas->statusmental3 == 'Sering lupa akan keterbatasan yang dimiliki') { ?>
        <?php $h = 'checked=""' ?>
        <?php } else { ?>
        <?php $hh ='checked=""' ?>
        <?php } ?>
...
<div class="col-lg-9">
  <a href="<?= $this->url->getStatic('asesmen/dataasesmen') ?>" class="btn btn-primary" > Cancel </a>
</div>
<div class="col-lg-3">
