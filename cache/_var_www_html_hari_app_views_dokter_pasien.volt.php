...
<div class="card col-lg-8">
    ...
    <div class="tab-pane active" id="one" role="tabpanel">
      <div class="form-group">
        ...
        <div class="card-collapsed" align="center">
          <a href="<?= $this->url->getStatic('Dokter/asesmen/') ?><?= $pb->id_berobat ?>" class="btn btn-primary btn-lg btn-icon m-b-1" ><i class="material-icons">
            library_add
          </i>
  ...
  <div class="tab-pane " id="two" role="tabpanel">
    <form action="<?= $this->url->getStatic('Dokter/diagnosa/') ?><?= $data->no_rm ?>" method="post">
      <div class="form-group">
