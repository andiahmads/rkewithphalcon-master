  ...
  <div class="card">
    ...
    <div class="card card-group">
      ...
      <div class="form-group">
       ...
       <div class="card-block col-lg-6">
        {% if data.nyeri == 'Tidak ada Nyeri' %}
        <?php $a = 'checked="" type="radio"'; ?>
        {% elseif data.nyeri == 'Nyeri Kronis' %}
        <?php $b = 'checked="";  type="radio"'; ?>
        {% elseif data.nyeri == 'Nyeri Akut' %}
   ...
   <div class="form-group m-b">
    ...
    <div class="col-lg-12 m-b-1">
      {% if data.nyeri_hilang == 'Minum Obat' %}
      <?php $aa = 'checked="" type="radio"' ?>
      {% elseif data.nyeri_hilang == 'Mendengar Musik' %}
      <?php $bb = 'checked="" type="radio"' ?>
      {% elseif data.nyeri_hilang == 'Istirahat' %}
      <?php $cc = 'checked="" type="radio"' ?>
      {% elseif data.nyeri_hilang == 'Berubah Posisi/Tidur' %}
    ...
    <table class="table-sm table-bordered col-lg-12">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center">15</td>
          <td align="center">
            {% if data.alatbantu1 == 'Tongkat/alat penopang' %}
            <?php $alatbantu1 = '15';
            echo '15'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">0</td>
          <td align="center">
            {% if data.alatbantu1 == 'Tidak ada/kursi roda/perawat/tirah baring' %}
            <?php $alatbantu1 = '0';
            echo '0'; ?>
            {% endif %}
          </td>
      ...
      <tr>
        ...
        <td align="center">20</td>
        <td align="center">
          {% if data.gayaberjalan1 == 'Terganggu' %}
     ...
     <tr>
      ...
      <td align="center">0</td>
      <td align="center">
       {% if data.gayaberjalan1 == 'Normal / tirah baring / imobilisasi' %}
       <?php $gayaberjalan1 = '0';
       echo '0'; ?>
       {% endif %}
     </td>
...
<td align="center">15</td>
<td align="center">
  {% if data.statusmental3 == 'Sering lupa akan keterbatasan yang dimiliki' %}
...
<tr>
  ...
  <td align="center">0</td>
  <td align="center">
    {% if data.statusmental3 == 'Orientasi baik terhadap kemampuan diri sendiri' %}
    <?php $statusmental3 = '0';
    echo '0'; ?>
    {% endif %}
  </td>
    ...
    <table class="table-sm table-bordered col-lg-12">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.usia1 == 'Kurang dari 50 tahun' %}
            <?php $usia1 = '8'; 
            echo '8'?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.usia1 == 'Lebih dari 80 tahun' %}
            <?php $usia1='26';
            echo '26'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.statusmental2 == 'Kesadaran baik' %}
            <?php $statusmental2='4';
            echo '4'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.statusmental2 == 'Agitasi/Ansietas' %}
        ...
        <tr>
          ...
          <td align="center">
            {% if data.statusmental2 == 'Kadang-kadang bingung' %}
        ...
        <tr>
          ...
          <td align="center">
            {% if data.statusmental2 == 'Bingung/Disorientasi' %}
            <?php $usia='14';
            echo '14'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.eliminasi1 == 'Mandiri dan mampu mengontrol BAB/BAK' %}
            <?php $eleminasi1='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.eliminasi1 == 'Dower Catheter/Colostomy' %}
            <?php $eleminasi1='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.eliminasi1 == 'Eliminasi dengan Bantuan' %}
            <?php $eleminasi1='10';
            echo '10'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.eliminasi1 == 'Gangguan Eliminasi' %}
            <?php $eleminasi1='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.eliminasi1 == 'Inkontinensia tetapi mampu untuk mobilisasi' %}
            <?php $eleminasi1='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.pengobatan1 == 'Tanpa obat-obatan' %}
            <?php $obat ='10';
            echo '10'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.pengobatan1 == 'Obat-obatan jantung' %}
            <?php $obat ='10';
            echo '10'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.pengobatan1 == 'Obat-obat psikotropika' %}
            <?php $obat ='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.pengobatan1 == 'Mendapat tambahan obat-obatan dan/atau obat-obat PRN(psikiatri, antinyeri) yang diberikan dalam 24 j' %}
            <?php $obat ='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.diagnosa == 'Bipolar / Gangguan Schizoaffective' %}
            <?php $diagnosa='10';
            echo '10'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.diagnosa == 'Penggunaan Obat-obatan Terlarang / Ketergantungan ' %}
            <?php $diagnosa='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.diagnosa == 'Gangguan Depresi Mayor' %}
            <?php $diagnosa='10';
            echo '10'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.diagnosa == 'Dimensia / Delirium' %}
            <?php $diagnosa='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.ambulasi1 == 'Mandiri/ Keseimbangan baik/ immobilisasi' %}
            <?php $ambulasi1='7';
            echo '7'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.ambulasi1 == 'Dengan Alat Bantu (kursi roda dll)' %}
            <?php $ambulasi1='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.ambulasi1 == 'Vertigo/ kelemahan' %}
            <?php $ambulasi1='10';
            echo '10'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.ambulasi1 == 'Goyah/ membutuhkan bantuan dan menyadari kemampoan' %}
            <?php $ambulasi1='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.ambulasi1 == 'Goyah tapi lupa keterbatasan' %}
            <?php $ambulasi1='15';
            echo '15'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.nutrisi1 == 'Mengkonsumsi sedikit makanan atau minuman dalam 24' %}
            <?php $nutrisi1='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.nutrisi1 == 'Tidak ada kelainan dengan nafsu makan' %}
            <?php $nutrisi1='0';
            echo '0'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.polatidur == 'Tidak ada gangguan tidur' %}
            <?php $polatidur='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.polatidur == 'Ada keluhan gangguan tidur yang dilaporkan oleh pa' %}
            <?php $polatidur='12';
            echo '12'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.jatuh == 'Tidak ada riwayat jatuh' %}
            <?php $jatuh='8';
            echo '8'; ?>
            {% endif %}
          </td>
        ...
        <tr>
          ...
          <td align="center">
            {% if data.jatuh == 'Ada riwayat jatuh dalam 3 bulan terakhir' %}
            <?php $jatuh='12';
            echo '12'; ?>
            {% endif %}
          </td>
...
<div class="card card-group">
  <div class="form-group">
   ...
   <br>
   <form action="{{ static_url('dokter/datamedik/')}}{{data.id_asesmen}}/{{data.id_berobat}}" method="post">
    <div class="form-group col-lg-12">
      <div  class="col-lg-3"><label>Golongan Darah </label> </div>
      <div class="col-lg-9">
        <div class="form-group m-b">
          <label class=" custom-control custom-radio" >
            <input id="radio1" name="golongandarah" value="A" type="radio" class="custom-control-input" ></input>
            <span class="custom-control-indicator" ></span>
            <span class="custom-control-description"> A </span>
          </label>
          <label class=" custom-control custom-radio" >
            <input id="radio1" name="golongandarah" value="B" type="radio" class="custom-control-input" ></input>
            <span class="custom-control-indicator" ></span>
            <span class="custom-control-description">B</span>
          </label>
          <label class=" custom-control custom-radio" >
            <input id="radio1" name="golongandarah" value="AB" type="radio" class="custom-control-input" ></input>
            <span class="custom-control-indicator" ></span>
            <span class="custom-control-description">AB</span>
          </label>
          <label class=" custom-control custom-radio" >
            <input id="radio1" name="golongandarah" value="O" type="radio" class="custom-control-input" ></input>
            <span class="custom-control-indicator" ></span>
    ...
    <div class="form-group col-lg-12">
      ...
      <div class="form-group col-lg-1">
        <input type="number" class="form-control btn-sm" name="tekanandarah1" ></input>
      </div>
      <div class="form-group col-xs-1" align="center">
        <label > / </label>
      </div>
      <div class="form-group col-lg-1">
        <input type="number" class="form-control btn-sm" name="tekanandarah2" ></input>
      </div>
      <div class="form-group m-b">
        <label class=" custom-control custom-radio" >
          <input id="radio1" name="tekanandarah" value="hypertensi" type="radio" class="custom-control-input" ></input>
          <span class="custom-control-indicator" ></span>
          <span class="custom-control-description"> Hypertensi </span>
        </label>
        <label class=" custom-control custom-radio" >
          <input id="radio1" name="tekanandarah" value="hypotensi" type="radio" class="custom-control-input" ></input>
          <span class="custom-control-indicator" ></span>
          <span class="custom-control-description">Hypotensi</span>
        </label>
        <label class=" custom-control custom-radio" >
          <input id="radio1" name="tekanandarah" value="normal" type="radio" class="custom-control-input" ></input>
          <span class="custom-control-indicator" ></span>
    ...
    <div class="form-group col-lg-12">
      ...
      <div class="col-lg-3">
        <div class="form-group ">
          <label class=" custom-control custom-radio" >
            <input id="radio1" name="tekananjantung" value="Tidak Ada" type="radio" class="custom-control-input" ></input>
            <span class="custom-control-indicator" ></span>
            <span class="custom-control-description"> Tidak Ada </span>
          </label>
          <label class=" custom-control custom-radio" >
            <input id="radio1" name="tekananjantung" value="Ada" type="radio" class="custom-control-input" ></input>
            <span class="custom-control-indicator" ></span>
      ...
      <div class="form-group col-lg-6">
       ...
       <div class="col-lg-10">
         <input class="form-control btn-sm" type="text" name="tjket"></input>
       </div>
     </div>
   </div>
   ...
   <div class="form-group col-lg-12">
    ...
    <div class="col-lg-3">
      <div class="form-group ">
        <label class=" custom-control custom-radio" >
          <input id="radio1" name="diabetes" value="Tidak Ada" type="radio" class="custom-control-input" ></input>
          <span class="custom-control-indicator" ></span>
          <span class="custom-control-description"> Tidak Ada </span>
        </label>
        <label class=" custom-control custom-radio" >
          <input id="radio1" name="diabetes" value="Ada" type="radio" class="custom-control-input" ></input>
          <span class="custom-control-indicator" ></span>
          <span class="custom-control-description"> Ada : </span>
        </label>        
      </div>
 ...
 <img class="col-lg-12" src="{{ static_url('img/gigi.png')}} " height="350">
</div>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
    <div class="form-group m-b">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="oklusi" value="normal bite" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> normal bite </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="oklusi" value="Cross bite" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Cross bite</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="oklusi" value="deep bite" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
    <div class="form-group m-b">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="toruspalatinus" value="tidak ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Tidak ada </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="toruspalatinus" value="kecil" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Kecil</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="toruspalatinus" value="sedang" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Sedang</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="toruspalatinus" value="besar" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Besar</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="toruspalatinus" value="multiple" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
    <div class="form-group m-b">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="torusmandibularis" value="tidak ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Tidak ada </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="torusmandibularis" value="kecil" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Kecil</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="torusmandibularis" value="sedang" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Sedang</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="torusmandibularis" value="besar" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Besar</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="torusmandibularis" value="multiple" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Multiple</span>
      </label>
    </div>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
    <div class="form-group m-b">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="palatum" value="Dalam" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Dalam </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="palatum" value="Sedang" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description">Sedang</span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="palatum" value="Rendah" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-3">
    <div class="form-group ">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="supernumerary" value="Tidak Ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Tidak Ada </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="supernumerary" value="Ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Ada : </span>
      </label>        
    </div>
  ...
  <div class="form-group col-lg-6">
   ...
   <div class="col-lg-10">
     <input class="form-control btn-sm" type="text" name="supernumeraryket"></input>
   </div>
 </div>
</div>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-3">
    <div class="form-group ">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="Diastema" value="Tidak Ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Tidak Ada </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="Diastema" value="Ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Ada : </span>
      </label>        
    </div>
  ...
  <div class="form-group col-lg-6">
   ...
   <div class="col-lg-10">
     <input class="form-control btn-sm" type="text" name="Diastemaket"></input>
   </div>
 </div>
</div>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-3">
    <div class="form-group ">
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="Gigianomali" value="Tidak Ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Tidak Ada </span>
      </label>
      <label class=" custom-control custom-radio" >
        <input id="radio1" name="Gigianomali" value="Ada" type="radio" class="custom-control-input" ></input>
        <span class="custom-control-indicator" ></span>
        <span class="custom-control-description"> Ada : </span>
      </label>        
    </div>
  ...
  <div class="form-group col-lg-6">
   ...
   <div class="col-lg-10">
     <input class="form-control btn-sm" type="text" name="Gigianomaliket"></input>
   </div>
 </div>
</div>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-8">
   <input class="form-control btn-sm" type="text" name="lain"></input>
 </div>
</div>
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-8">
   <input class="form-control btn-sm" type="text" name="Keterangan"></input>
 </div>
</div>
...
<div class="table-responsive ">
  <table class="table-sm table-bordered col-lg-12">
   ...
   <tbody>
    <tr>
      <td> 18 : <input class="form-control btn-sm col-lg-4" name="18"> </input></td>
      <td> 28 : <input class="form-control btn-sm col-lg-4" name="28"> </input></td>
      <td> 38 : <input class="form-control btn-sm col-lg-4" name="38"> </input></td>
      <td> 48 : <input class="form-control btn-sm col-lg-4" name="48"> </input></td>
    </tr>
    <tr>
      <td> 17 : <input class="form-control btn-sm col-lg-4" name="17"> </input></td>
      <td> 27 : <input class="form-control btn-sm col-lg-4" name="27"> </input></td>
      <td> 37 : <input class="form-control btn-sm col-lg-4" name="37"> </input></td>
      <td> 47 : <input class="form-control btn-sm col-lg-4" name="47"> </input></td>
    </tr>
    <tr>
      <td> 16 : <input class="form-control btn-sm col-lg-4" name="16"> </input></td>
      <td> 26 : <input class="form-control btn-sm col-lg-4" name="26"> </input></td>
      <td> 36 : <input class="form-control btn-sm col-lg-4" name="36"> </input></td>
      <td> 46 : <input class="form-control btn-sm col-lg-4" name="46"> </input></td>
    </tr>
    <tr>
      <td> 15/55 : <input class="form-control btn-sm col-lg-4" name="15/55"> </input></td>
      <td> 25/65 : <input class="form-control btn-sm col-lg-4" name="25/65"></input></td>
      <td> 35/75 : <input class="form-control btn-sm col-lg-4" name="35/75"> </input></td>
      <td> 45/85 : <input class="form-control btn-sm col-lg-4" name="45/85"> </input></td>
    </tr>
    <tr>
      <td> 14/54 : <input class="form-control btn-sm col-lg-4" name="14/54"> </input></td>
      <td> 24/64 : <input class="form-control btn-sm col-lg-4" name="24/64"> </input></td>
      <td> 34/74 : <input class="form-control btn-sm col-lg-4" name="34/74"> </input></td>
      <td> 44/84 : <input class="form-control btn-sm col-lg-4" name="44/84"> </input></td>
    </tr>
    <tr>
      <td> 13/53 : <input class="form-control btn-sm col-lg-4" name="13/53"> </input></td>
      <td> 23/63 : <input class="form-control btn-sm col-lg-4" name="23/63"> </input></td>
      <td> 33/73 : <input class="form-control btn-sm col-lg-4" name="33/73"> </input></td>
      <td> 43/83 : <input class="form-control btn-sm col-lg-4" name="43/83"> </input></td>
    </tr>
    <tr>
      <td> 12/52 : <input class="form-control btn-sm col-lg-4" name="12/52"> </input></td>
      <td> 22/62 : <input class="form-control btn-sm col-lg-4" name="22/62"> </input></td>
      <td> 32/72 : <input class="form-control btn-sm col-lg-4" name="32/72"> </input></td>
      <td> 42/82 : <input class="form-control btn-sm col-lg-4" name="42/82"> </input></td>
    </tr>
    <tr>
      <td> 11/51 : <input class="form-control btn-sm col-lg-4" name="11/51"> </input></td>
      <td> 21/61 : <input class="form-control btn-sm col-lg-4" name="21/61"> </input></td>
      <td> 31/71 : <input class="form-control btn-sm col-lg-4" name="31/71"> </input></td>
      <td> 41/81 : <input class="form-control btn-sm col-lg-4" name="41/81"> </input></td>
    </tr>
  </tbody>
</table>
</div>
