    ...
    <div class="card-block">
      ...
      <div class="col-lg-12">
        ...
        <div class="user-image col-lg-3" align="center">
          <img src="{{ static_url('images/avatar.jpg') }}" class="avatar img-circle" height="200" width="200">
        </div>
        <div class="col-lg-8">
          ...
          <table  class="table table-bordered datatable">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ ad.tanggal }}</td>
                <td >
                 <a href="{{static_url('Dokter/editasesmen/')}}{{ad.id_asesmen}}" class="btn btn-warning btn-sm"><i class="material-icons">edit</i></a>
               </td>
             </tr>
             {% endfor %}
            ...
            <tbody>
              ...
              <div class="modal fade" id="myModal{{ data.id_diagnosa }}" role="dialog">
                <div class="modal-dialog">
                  <!-- Modal content-->
                  <form action="{{ static_url('Dokter/editdiagnosa/')}}{{data.id_diagnosa}}" method="POST">
                   <div class="card">
