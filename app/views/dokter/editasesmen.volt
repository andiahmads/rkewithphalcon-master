...
<div class="card card-group">
  <div class="form-group">
   ...
   <br>
   <form action="{{ static_url('dokter/proseseditasesmen/')}}{{data.id_asesmen}}/{{data.no_rm}}" method="post">
    <div class="form-group col-lg-12">
      <div  class="col-lg-3"><label>Golongan Darah </label> </div>
      {% if data.golongandarah == 'A' %}
        <?php $a = 'checked=""'; ?>
      {% elseif data.golongandarah == 'B' %}
        <?php $b = 'checked=""'; ?>
      {% elseif data.golongandarah == 'AB' %}
        <?php $ab = 'checked=""'; ?>
      {% else %}
        <?php $o = 'checked=""'; ?>
      {% endif %}
    ...
    <div class="form-group col-lg-12">
      ...
      {% if data.tekanandarah == 'hypertensi' %}
        <?php $t = 'checked=""'; ?>
      {% elseif data.tekanandarah == 'hypotensi' %}
        <?php $tt = 'checked=""'; ?>
      {% else %}
        <?php $ttt = 'checked=""'; ?>
      {% endif %}
    ...
    <div class="form-group col-lg-12">
      <div  class="col-lg-3"><label>Tekanan Jantung</label> </div>
       {% if data.tekananjantung == 'Tidak Ada' %}
        <?php $q = 'checked=""'; ?>
      {% else %}
        <?php $qq = 'checked=""'; ?>
      {% endif %}
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
      ...
      {% if data.oklusi == 'normal bite' %}
        <?php $e = 'checked=""'; ?>
      {% elseif data.oklusi == 'Cross bite' %}
        <?php $ee = 'checked=""'; ?>
      {% else %}
        <?php $eee = 'checked=""'; ?>
      {% endif %}
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
      {% if data.toruspalatinus == 'tidak ada' %}
        <?php $r = 'checked=""'; ?>
      {% elseif data.toruspalatinus == 'kecil' %}
        <?php $rr = 'checked=""'; ?>
      {% elseif data.toruspalatinus == 'sedang' %}
        <?php $rrr = 'checked=""'; ?>
      {% elseif data.toruspalatinus == 'besar' %}
        <?php $rrrr = 'checked=""'; ?>
      {% else %}
        <?php $rrrrr = 'checked=""'; ?>
      {% endif %}
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
      {% if data.torusmandibularis == 'tidak ada' %}
        <?php $r = 'checked=""'; ?>
      {% elseif data.torusmandibularis == 'kecil' %}
        <?php $rr = 'checked=""'; ?>
      {% elseif data.torusmandibularis == 'sedang' %}
        <?php $rrr = 'checked=""'; ?>
      {% elseif data.torusmandibularis == 'besar' %}
        <?php $rrrr = 'checked=""'; ?>
      {% else %}
        <?php $rrrrr = 'checked=""'; ?>
      {% endif %}
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-9">
  {% if data.palatum == 'Dalam' %}
        <?php $t = 'checked=""'; ?>
      {% elseif data.palatum == 'Sedang' %}
        <?php $tt = 'checked=""'; ?>
      {% else %}
        <?php $ttt = 'checked=""'; ?>
      {% endif %}
...
<div class="form-group col-lg-12">
  ...
  <div class="col-lg-3">
       ...
       {% if data.supernumerary == 'Tidak Ada' %}
        <?php $as = 'checked=""'; ?>
      {% else %}
        <?php $ass = 'checked=""'; ?>
      {% endif %}
