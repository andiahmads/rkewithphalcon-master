            ...
            <div class="content-view">
              <div class="card">
                ...
                <div class="card-footer text-xs-right">
                  ...
                  <a href="{{static_url('detailpembayaran/update/')}} {{ datas.id_berobat }}" name="konfirmasi" class="btn btn-info btn-icon btn-sm " value="lunas"  href="javascript:;" title="tombol ini berguna untuk konfirmasi status pasien">
