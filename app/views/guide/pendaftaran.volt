	...
	<div class="col-lg-9">
        ...
        <div class="row">
          <div class="col-lg-6 ">
            ...
            <form action="{{static_url('Pendaftaran/insert')}}" method="POST">
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="card">
                            ...
                            <div class="card-block">
                              <div class="m-b">
                                <form name="role" action="{{static_url('Pasienbaru/insert')}}" method="post">
                                <p class="m-t-1">Nomor Rm</p>
                    <div class="m-b">
                                               ...
                                               <div class="modal-dialog">
                                                   <div class="modal-content">
                                                       ...
                                                       <div class="modal-body">
                                                           ...
                                                           <form action="{{ url('pendaftaran/ubah') }}/{{datas.id_berobat}}"class="form-horizontal"method="POST">
