...
<tbody>
    ...
    <tr>
        ...
        <td >
            {% if d.level_pengguna == 'admin' %}
            {% if d.nik == session.nik %}
                            ...
                            <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="level_pengguna"  class="form-control">
                                        ...
                                        {% elseif d.level_pengguna == 'dokter' %}
                                        <option>
                                            dokter
                                        </option>
                                        <option>
            ...
            <div class="modal-body">
                <form action="Pengguna/create"class="form-horizontal"method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <div class='col-md-9'><input type="text" name="poly" autocomplete="off"  placeholder="Enter poly" class="form-control m-b-1" ></div>
                    </div>
                    <div class="">
