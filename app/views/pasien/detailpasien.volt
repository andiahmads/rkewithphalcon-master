<div class="card-header bg-white ">
  <div class="col-lg-8">
<div class="col-lg-2">
  <img src="{{ static_url('img/riau.png')}}" height="120">
</div>
<div class="col-lg-9">
...
<div class="row">
  ...
  <div class="col-lg-6">
    <div class="card">
    <div class="card-header bg-white">
     <form action="{{static_url('Pendaftaran/update/')}} {{ data.no_rm }}" method="POST">
              ...
              <input type="date" name="tanggal" class="form-control" value="{{ data.tanggal_lahir}}" placeholder="tanggal"/>
                  ...
                  {% endif %}
                    ...
                    <div class="custom-control-stacked" >
                      ...
                      {% if data.status == 'Tidak_Kawin' %}
                      <?php $tk = 'checked =""' ?>
                      {% elseif data.status == 'Kawin' %}
                      <?php $kw = 'checked =""' ?>
                       {% elseif data.status == 'Cerai_Hidup' %}
                      <?php $ch = 'checked =""' ?>
                       {% else %}
                      <?php $cm = 'checked =""' ?>
                    ...
                    <div class="custom-control-stacked">
                      ...
                      {% if data.pendidikan == 'Tidak_Sekolah' %}
                      <?php $ts = 'checked =""' ?>
                      ...
                      {% elseif data.pendidikan == 'Akademik' %}
                      <?php $ak = 'checked =""' ?>
                       {% else %}
                      <?php $unv = 'checked =""' ?>
                    ...
                    <div class="custom-control-stacked">
                     ...
                     {% if data.pekerjaan == 'Tidak_Kerja' %}
                      <?php $tk = 'checked =""' ?>
                       {% elseif data.pekerjaan == 'Buruh' %}
                      <?php $br = 'checked =""' ?>
                      {% elseif data.pekerjaan == 'Swasta' %}
                      <?php $sw = 'checked =""' ?>
                      {% elseif data.pekerjaan == 'Wiraswasta' %}
                      <?php $wr = 'checked =""' ?>
                      {% elseif data.pekerjaan == 'PNS' %}
                      <?php $pns = 'checked =""' ?>
                      {% elseif data.pekerjaan == 'TNI' %}
                      <?php $tni = 'checked =""' ?>
                      {% else %}
                      <?php $pl = 'checked=""' ?>
                      {% endif %}
